// Package chat_completions provides lightweight request normalization for the
...
// ConvertOpenAIRequestToOpenAI normalizes an OpenAI Chat Completions request by
// replacing the model field with the resolved upstream model name.
//
// Parameters:
...
//
// Returns:
//   - []byte: The normalized request payload
