...
// handleNonStreamingResponse handles non-streaming chat completion requests for
...
// handleStreamingResponse handles streaming chat completion requests for the
